  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white flex flex-col items-center justify-center px-5 py-20">
      ...
      <motion.h1
        ...
        className="text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400"
      >
        About Me
      </motion.h1>
      ...
      <motion.div 
        ...
        className="mt-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 text-center"
      >
        {[
          ...
          <div
            key={index}
            className="p-4 bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all"
          >
            {skill}
          </div>
        ))}
